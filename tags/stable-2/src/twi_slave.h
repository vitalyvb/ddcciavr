...
#define TWI_DIRECTION_SLAVE_READ (0)
#define TWI_DIRECTION_SLAVE_WRITE (1)

#define TWI_OPERATION_READ (1)
#define TWI_OPERATION_WRITE (2)
...
#define SLAVE_OUT_OF_SEND_DATA (0xff)
