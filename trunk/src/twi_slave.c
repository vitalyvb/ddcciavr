...
{
    TWAR = TWI_ownAddress << TWI_ADR_BITS;            // Set own TWI slave address. Accept TWI General Calls.

#ifdef PROVIDE_EDID
#warning TODO
    TWAR = (TWI_ownAddress | EDID_ADDRESS) << TWI_ADR_BITS;
    TWAMR = (TWI_ownAddress ^ EDID_ADDRESS) << TWI_ADR_BITS;
#endif
...
//    case TWI_STX_ADR_ACK_M_ARB_LOST: // Arbitration lost in SLA+R/W as Master; own SLA+R has been received; ACK has been returned
	twi_proto_start_write(TWDR);
    case TWI_STX_DATA_ACK:           // Data byte in TWDR has been transmitted; ACK has been received
	TWDR = twi_proto_get_sendbyte();
